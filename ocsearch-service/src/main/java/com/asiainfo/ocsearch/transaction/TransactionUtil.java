...
public class TransactionUtil {
    ...
    public static void serialize(String name, Transaction transaction) throws ServiceException {
        ...
        try {
            ...
            throw new ServiceException("can not serialize the transaction", ErrorCode.RUNTIME_ERROR);
    ...
    public static  void deleteTransaction(String name) throws ServiceException {
